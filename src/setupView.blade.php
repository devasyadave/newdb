...
<body class="app sidebar-mini rtl">
	...
	<div class="row">
            ...
            if (! mo_saml_is_customer_license_verified()) {
                ?>
                  <div class="mo_saml_not_registered">
					Please <a href="account.php">Login with your miniOrange account</a>
        ...
        ?>>
										...
										<td style="padding: 10px;">
											<div class="animated-radio-button">
												<label> <input type="radio" name="login_binding_type"
													...
													<?php
            if (DB::get_option('saml_login_binding_type') === 'HttpRedirect') {
                echo ' checked ';
            }
            ?>><span class="label-text">Http-Redirect</span>
										...
										<td style="padding: 10px;">
											...
											<div class="animated-radio-button">
												<label> <input type="radio" name="login_binding_type"
													id="http_post_binding" value="HttpPost"
													<?php
            if (DB::get_option('saml_login_binding_type') === 'HttpPost') {
                echo ' checked ';
            }
            ?>><span class="label-text">Http-Post</span>
								...
								<div class="form-group">
									<label for="saml_logout_url"><b>SAML Logout URL</b></label> <input
										class="form-control" name="saml_logout_url"
										id="saml_logout_url" type="text"
										<?php
        ...
        ?>><span class="label-text">Force
								...
								<div class="animated-checkbox">
									<label> <input type="checkbox" id="force_sso" name="force_sso"
										<?php
        ...
        ?>>
							...
							<div class="form-group">
								<label for="slo_url"><b>SINGLE LOGOUT URL</b></label> <input
