...
<body class="app sidebar-mini rtl">
	...
	<aside class="app-sidebar">
		...
		<ul class="app-menu">
			...
			<li><a class="app-menu__item" href="account.php"><i
	...
	<div class="row">
			...
			<div class="tile">
				<div class="row">
					<div class="col-lg-10">
						...
						<h4>Step 4:</h4>
						<p>
							Use the following URL as a link in your application from where
							you want to perform SSO:<br />
							<code>http://&lt;your-domain&gt;/sso/login.php</code>
						</p>
						<p>
							For example, you can use it as:<br />
							<code>&lt;a href="http://&lt;your-domain&gt;/sso/login.php&gt;Log
								in&lt;/a&gt;</code>
						...
						<form id="setup_form" method="POST" action="">
							...
							<div class="form-group">
								<label><b>Application URL</b> <!-- <span class="badge badge-pill badge-primary float-right" onclick="" title="The users will be redirected to this URL after logging in.">?</span> -->
									<i class="fa fa-question-circle" id="application_url_help"></i>
									<div style="display: none" class="help_desc"
										id="application_url_help_desc">
										<span>The users will be redirected to this URL after logging
											in.</span>
									</div> </label> <input class="form-control"
									name="application_url" id="application_url" type="text"
									<?php
        ...
        ?>>
							...
							<div class="form-group">
								<label><b>Site Logout URL</b> <!-- <span class="badge badge-pill badge-primary float-right" onclick="" title="The users will be redirected to this URL after logging in.">?</span> -->
									<i class="fa fa-question-circle" id="logout_url_help"></i>
									<div style="display: none" class="help_desc"
										id="logout_url_help_desc">The users will be redirected to this
										URL after logging out.</div> </label> <input
        ...
        ?>> <br />
							...
							<h4>Step 6:</h4>
							<p>Please provide your application URL in the above field and use
								the following code in your application to access the user
								attributes:</p>
    ...
    // The above piece of code will display all the attributes received and mapped in the connector.
						...
						<p>
							Use the following URL as a link in your application from where
							you want to perform SLO:<br />
							<code>http://&lt;your-domain&gt;/sso/logout.php</code>
						</p>
						<p>
							For example, you can use it as:<br />
							<code>&lt;a
								href="http://&lt;your-domain&gt;/sso/logout.php&gt;Log
								out&lt;/a&gt;</code>
